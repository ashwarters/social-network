...
const thoughtController = {
    ...
    createThought(req, res) {
        Thought.create(req.body)
            .then((_id) => {
                return Thought.findOneAndUpdate({ _id: req.body.id }, { $push: { User: thought._id } }, { new: true });
            })
            .then(dbThoughtData => {
                if (!dbThoughtData) {
    ...
    deleteThought({ params }, res) {
        Thought.findOneAndUpdate({ _id: params.thoughtId }, { $pull: { thoughts: { thoughtId: params.thoughtId } } }, { new: true })
